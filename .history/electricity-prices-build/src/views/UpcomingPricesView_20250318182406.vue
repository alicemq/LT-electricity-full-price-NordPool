...
const loadPrices = async () => {
  try {
    ...
    // Extract data arrays from responses and handle cases where data might be undefined
    const todayData = todayPrices?.data || [];
    const tomorrowData = tomorrowPrices?.data || [];
