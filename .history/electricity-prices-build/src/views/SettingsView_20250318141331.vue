  ...
  <div class="settings-page">
    ...
    <div class="settings">
      <div class="settings-form">
        ...
        <div class="form-group">
          <label>Price Range from Average (%)</label>
          <small class="text-muted d-block">±15% means: prices 15% below average are cheap, 15% above average are expensive</small>
          <input type="number" v-model="settings.rangePercentage" step="1" min="1" max="100">
        </div>
      </div>
    </div>
  ...
  data() {
    return {
      settings: {
        ...
        rangePercentage: 15  // Single percentage for both above and below average
      }
    }
  },
  created() {
